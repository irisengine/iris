    ...
    , gpu_allocators_()
{
    cpu_allocators_.insert(
        {D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, {D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, 10240u * 20u, 100u}});
    cpu_allocators_.insert({D3D12_DESCRIPTOR_HEAP_TYPE_RTV, {D3D12_DESCRIPTOR_HEAP_TYPE_RTV, 10240u * 20u, 100u}});
    cpu_allocators_.insert({D3D12_DESCRIPTOR_HEAP_TYPE_DSV, {D3D12_DESCRIPTOR_HEAP_TYPE_DSV, 10240u * 20u, 100u}});
    gpu_allocators_.insert(
        {D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, {D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, 10240u * 20u}});
}
