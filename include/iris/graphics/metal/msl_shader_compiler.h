 ...
 */
class MSLShaderCompiler : public ShaderCompiler
{
  public:
    /**
     * Construct a new MLSLSHaderCompiler.
     *
     * @param render_graph
     *   RenderGraph to compile into MLSL.
     *
     * @param light_type
     *   The type of light to render with.
     */
    MSLShaderCompiler(const RenderGraph *render_graph, LightType light_type);

    ~MSLShaderCompiler() override = default;
