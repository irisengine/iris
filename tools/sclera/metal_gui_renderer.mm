    ...
    , camera_(camera)
{
    ...
    impl_->renderer = std::make_unique<ActualMetalGuiRenderer>(
        ...
        [this]
        {
            ...
            //         nullptr, ctx.mesh_manager().cube(iris::Colour{1.0f, 1.0f, 1.0f}), iris::Transform{{}, {},
            //         {1.0f}}));
            // }
...
void MetalGuiRenderer::handle_input(const iris::Event &event)
{
    impl_->gui->handle_input(event);
